...
export default function Search() {
   ...
   console.log('check proce', process.env.NEXT_PUBLIC_API_ENDPOINT);
   

   const classes = {
      container:
         "border border-black/10 flex h-[30px] rounded-[99px] px-[10px]",
      input: "placeholder:text-[#808080] h-full bg-transparent outline-none text-[#333] text-[16px]",
      searchItem:
